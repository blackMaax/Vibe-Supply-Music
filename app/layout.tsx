...
import { getSiteSettings, type SiteSettingsData } from "@/sanity/lib/queries.ts" // Corrected import path for SiteSettingsData and getSiteSettings
import { urlFor } from "@/sanity/lib/image.ts"; // Correct import for Sanity image URL builder
