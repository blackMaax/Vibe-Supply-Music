...
// ../node_modules/.pnpm/@sanity+types@3.88.3_@types+react@19.1.4_debug@4.4.0/node_modules/@sanity/types/lib/index.mjs
...
function isPortableTextTextBlock(value) {
  ...
  Array.isArray(value.children) && value.children.every((child) => isRecord$1(child)) && ("markDefs" in value ? Array.isArray(value.markDefs) && value.markDefs.every((def) => isRecord$1(def)) : true) && ("style" in value ? typeof value.style == "string" : true);
}
...
function isDeprecatedSchemaType(type) {
  return isRecord(type) ? typeof type.deprecated < "u" : false;
}
...
var searchStrategies = ["groqLegacy", "groq2024"];
...
//# sourceMappingURL=@sanity_types.js.map
