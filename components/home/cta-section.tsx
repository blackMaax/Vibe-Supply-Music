...
const PackageCard = ({ name, tagline, features = [], isPopular = false, image }: PackageCardProps) => {
  ...
  return (
    ...
    >
      <div className="h-full flex flex-col overflow-hidden rounded-xl relative" style={{
        backgroundColor: '#000080',
        backgroundImage: 'url("https://www.transparenttextures.com/patterns/classy-fabric.png")',
        ...
        <div className="absolute bottom-3 left-3 w-4 h-4 text-gold/60 pointer-events-none z-10">
          <svg width="100%" height="100%" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path d="M1 0V15H16" stroke="currentColor" strokeWidth="1.5"/>
          </svg>
        </div>
        <div className="absolute bottom-3 right-3 w-4 h-4 text-gold/60 pointer-events-none z-10">
          <svg width="100%" height="100%" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path d="M15 0V15H0" stroke="currentColor" strokeWidth="1.5"/>
          </svg>
        </div>
        
        {/* Top: Image section with no overlaid text */}
        <div className="relative h-64 w-full overflow-hidden flex-shrink-0 rounded-t-xl">
          {resolvedImageSrc && (
            <Image
        ...
        <div className={`flex-grow flex flex-col relative p-8 ${isPopular ? "border-t-2 border-gold" : "border-t border-white/10"}`}>
          {/* Content elements */}
